  ...
  return (
    <main className="dashboard-page">
      <header className="dashboard-header">
        <div><p className="eyebrow">VoxInsight</p><h1>Grounded Assistant</h1></div>
