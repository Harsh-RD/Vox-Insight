...
function SearchContent() {
  ...
  return <main className="dashboard-page"><header className="dashboard-header"><div><p className="eyebrow">VoxInsight</p><h1>Semantic search</h1></div><Link className="secondary-link" href="/dashboard">Workspace</Link></header>
